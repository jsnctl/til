...
* 12-02-18: Keras (especially when booting on a fresh EC2 instance) will often need the env varables ```export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:/usr/local/cuda/lib64"
